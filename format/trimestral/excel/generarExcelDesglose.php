...
FROM (
  SELECT  pre.nombre, 
    ...
    ,CASE 
      ...
      WHEN seg.idPregunta = 27 AND $getAnio  >= 2022 AND $getPeriodo >= 1 AND seg.idEnlace IN (9,72,26,6,38,5,2,28,391) THEN (SELECT COUNT(NUC) AS totalNuc FROM trimestral.nucsTrimestral WHERE idPregunta = 27 and anio = $getAnio and periodo = $getPeriodo and idEnlace = seg.idEnlace) 
